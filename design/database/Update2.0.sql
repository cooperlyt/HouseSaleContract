...
ALTER TABLE CONTRACT.HOUSE_CONTRACT MODIFY CREATE_TIME DATETIME NOT NULL;
...
UPDATE CONTRACT.HOUSE_CONTRACT set HOUSE_AREA = 0;
...
ALTER TABLE CONTRACT.CONTRACT_OWNER DROP FOREIGN KEY contract_owner_ibfk_1;
