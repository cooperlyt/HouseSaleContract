...
//    }
    ...
    public String viewSingleContract() {
        if (!"NONE".equals(RunParam.instance().getParamValue("USE_FINGERPRINT"))) {
            FingerCollection.instance().setContractNumber(getInstance().getId());
            if (!FingerCollection.instance().isFingerComplete())
